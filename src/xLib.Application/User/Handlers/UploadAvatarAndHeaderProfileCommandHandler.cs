...
public class UploadAvatarAndHeaderProfileCommandHandler : IRequestHandler<UploadAvatarAndHeaderProfileCommand, BlobResponseDto>
{
    ...
    public async Task<BlobResponseDto> Handle(UploadAvatarAndHeaderProfileCommand request, CancellationToken cancellationToken)
    {
